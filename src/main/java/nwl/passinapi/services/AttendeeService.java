...
import nwl.passinapi.domain.attendee.exceptions.AttendeeAlreadyExistException;
import nwl.passinapi.domain.attendee.exceptions.AttendeeNotFoundException;
import nwl.passinapi.domain.checkin.CheckIn;
import nwl.passinapi.dto.attendee.AttendeeBadgeDTO;
import nwl.passinapi.dto.attendee.AttendeeBadgeResponseDTO;
...
public class AttendeeService {
    ...
    public void verifyAttendeeSubscription(String email, String eventId) {
        ...
        if (isAttendeeRegistered.isPresent()) throw new AttendeeAlreadyExistException("ATTENDE ALREADY IS REGISTERED");
    }
